...
public class Map extends FragmentActivity implements OnMapReadyCallback
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        AppCenter.start(getApplication(), "e48d5a6a-75a8-45c7-8a2e-b06210c8f839",
        ...
        Analytics.trackEvent("Aplicacion abierta");
    ...
    private void createLocationCallback()
    {
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                //MarkerOptions marker = new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory.decodeResource(getApplicationContext().getResources(), R.drawable.penguin)));
                ...
                Marker markerABorrar = null;
                double distanciaEnKm;
                boolean borrar = false;
                for(Marker m : markers)
                {
                    distanciaEnKm = distanciaEnKM(ltlng.latitude, ltlng.longitude, m.getPosition().latitude, m.getPosition().longitude);

                    if(distanciaEnKm * 1000 < 20)
                    {
                        Toast.makeText(getApplicationContext(), "Encontraste un punto!", Toast.LENGTH_LONG).show();
                        markerABorrar = m;
                        borrar = true;
                    }
                }

                if(borrar && markerABorrar != null)
                {
                    markerABorrar.remove();
                    markers.remove(markerABorrar);
    ...
    private void generateNewMarker()
    {
        ...
        //distancia aleatoria limitada al rango (400)
        double distancia = ((0.001 * 400) / 111.32) * Math.random();
        ...
        MarkerOptions mark = new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory.decodeResource(getApplicationContext().getResources(), R.drawable.penguin)));
        ...
        drawCircle(new LatLng(lat, lng), 20);

        contadorMarkers++;
    }

    private Circle drawCircle(LatLng point, int rangeInMeters){
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(Map.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(Map.this, errorMessage, Toast.LENGTH_LONG).show();
                                mRequestingLocationUpdates = false;
                        }
